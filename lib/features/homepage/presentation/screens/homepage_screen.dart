...
class _HomepageScreenState extends State<HomepageScreen> {
  ...
  List<GeoCache> get filteredCaches {
    ...
    return caches
        .where((cache) => cache.name.toLowerCase().contains(searchQuery.toLowerCase()))
        .toList();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // AGORA USANDO A LISTA FILTRADA DINAMICAMENTE:
      body: HomepageAdaptive(caches: filteredCaches), 
    );
  }
}